...
#==========================================================================Lables
    ...
    def retranslateUi(self, FarsiNevis):
        ...
        self.cmbPe.setItemText(2, _translate("FarsiNevis", "ب"))
        self.cmbPe.setItemText(3, _translate("FarsiNevis", "بٍ"))
        self.cmbPe.setItemText(4, _translate("FarsiNevis", "يِـ"))
        self.cmbPe.setItemText(5, _translate("FarsiNevis", "يٍـ"))
        self.cmbPe.setItemText(6, _translate("FarsiNevis", "ىٍـ"))
        self.cmbPe.setItemText(7, _translate("FarsiNevis", "ىِـ"))
